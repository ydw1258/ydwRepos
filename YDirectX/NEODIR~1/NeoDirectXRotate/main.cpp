...
void SetupMareices()
{
	...
	g_Camera.update_trans(g_pD3DDevice);

	//D3DXVECTOR3 vEyept(.0f, 3.0f, -5.0f);
	//D3DXVECTOR3 vLootatPt(.0f, .0f, .0f);

	//// 0, 1, 0 으로 고정 시킨다.
	//D3DXVECTOR3 vUpVec(.0f, 13.0f, .0f);
