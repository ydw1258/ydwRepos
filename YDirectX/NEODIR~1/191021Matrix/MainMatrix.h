...
struct MMatrix
{
	...
	MVector4 VecMultiMat(const MVector4& _Vec)
	{
		MVector4 Tmp;

		Tmp.x = (_Vec.x * this->V1.x + _Vec.y * this->V2.x + _Vec.z * this->V3.x + _Vec.w * this->V4.x);
		Tmp.y = (_Vec.x * this->V1.y + _Vec.y * this->V2.y + _Vec.z * this->V3.y + _Vec.w * this->V4.y);
		Tmp.z = (_Vec.x * this->V1.z + _Vec.y * this->V2.z + _Vec.z * this->V3.z + _Vec.w * this->V4.z);
		Tmp.w = (_Vec.x * this->V1.w + _Vec.y * this->V2.w + _Vec.z * this->V3.w + _Vec.w * this->V4.w);
